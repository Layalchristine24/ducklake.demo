...
The `ATTACH ... AS lake` statement creates a **catalog** (database) named `lake`. Tables are then accessed as `lake.table_name` (using the default schema) or `lake.schema_name.table_name`.
